...
HMODULE __stdcall RemoteOps::GetRemoteModuleHandle(HANDLE hProcess, LPCSTR lpModuleName) {
...
FARPROC __stdcall RemoteOps::GetRemoteProcAddress(HANDLE hProcess, HMODULE hModule, LPCSTR lpProcName, UINT Ordinal, BOOL UseOrdinal) {
	BOOL Is64Bit = FALSE;
